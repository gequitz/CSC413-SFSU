    ...
    TokenSetup() {
        try {
          ...
          //  symbols = new PrintWriter(new FileOutputStream("lexer" + sep + "Tokens.java"));
            ...
            //  in = new BufferedReader(new FileReader("lexer" + sep + "setup" + sep + "tokens"));
            in = new BufferedReader(new FileReader("C:\\Users\\Maria\\Documents\\NetBeansProjects\\Lexer\\tokens"));
          //  table = new PrintWriter(new FileOutputStream("lexer" + sep + "TokenType.java"));
            table = new PrintWriter(new FileOutputStream("C:\\Users\\Maria\\Documents\\NetBeansProjects\\Lexer\\TokenType.java"));
          //  symbols = new PrintWriter(new FileOutputStream("lexer" + sep + "Tokens.java"));
            symbols = new PrintWriter(new FileOutputStream("C:\\Users\\Maria\\Documents\\NetBeansProjects\\Lexer\\Tokens.java"));
